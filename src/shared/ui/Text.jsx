...
const propsToStyles = (props) =>  {
  ...
  if (props.$aling) styles += `text-align: ${props.$aling};`;
  if (props.$transition) {
  ...
  Object.entries(props).forEach(([key, value]) => {
    ...
    if (["$decoration","$color","$weight","$family","$size","$cursor","$aling","$transition","$hover"].includes(key)) return;
